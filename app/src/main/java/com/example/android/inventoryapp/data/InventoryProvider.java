...
/**
 * Created by ebtesam on 1/10/2018 AD.
 */
...
public class InventoryProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            case INVENTORY:
                ...
                cursor = database.query(InventoryContract.Entry.TABLE_NAME, projection, selection, selectionArgs, null, null, sortOrder);
                break;
            case INVENTORY_ID:
                ...
                cursor = database.query(InventoryContract.Entry.TABLE_NAME, projection, selection, selectionArgs,
                        null, null, sortOrder);
                break;
            default:
    ...
    private Uri insertInventory(Uri uri, ContentValues values) {
        ...
        long id = database.insert(InventoryContract.Entry.TABLE_NAME, null, values);
...
// Notify all listeners that the data has changed for the pet content URI
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            case INVENTORY:
                return InventoryContract.Entry.CONTENT_LIST_TYPE;
            case INVENTORY_ID:
                return InventoryContract.Entry.CONTENT_ITEM_TYPE;
            default:
